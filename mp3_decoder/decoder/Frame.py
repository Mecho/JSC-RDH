...
from mp3_decoder.decoder import tables
from mp3_decoder.decoder import util
from mp3_decoder.decoder.FrameHeader import *
from mp3_decoder.decoder.FrameSideInformation import FrameSideInformation
...
class Frame:
    ...
    def __init__(self):
        ...
        self.__raw_quantized_samples: np.ndarray = np.zeros((2, 2, NUM_OF_SAMPLES), dtype=np.int32)
    ...
    def init_frame_params(self, buffer: list, file_data: list, curr_offset: int):
        ...
        # Save raw quantized samples before re-quantization
        self.__raw_quantized_samples = self.__samples.copy().astype(np.int32)
    ...
    @property
    def raw_quantized_samples(self):
        return self.__raw_quantized_samples
